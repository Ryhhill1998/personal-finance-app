...
def test_get_all_transactions_for_bank_for_year(mock_data: None, override_get_settings: None):
    # ARRANGE
    bank_name = "lloyds"
    client = TestClient(app)

    # ACT
    response = client.get(f"/transactions/?bank_name={bank_name}&year=2024")
...
def test_get_all_transactions_for_year(
    mock_data: None, override_get_settings: None, year: int, expected_transactions: list[Transaction]
) -> None:
    # ARRANGE
    client = TestClient(app)

    # ACT
    response = client.get(f"/transactions/?year={year}")
...
def test_get_transactions_raises_400_exception_for_invalid_query_params() -> None:
    pass


def test_get_transactions_raises_404_exception_if_no_data_found() -> None:
    pass


def test_get_transactions_raises_500_exception_if_stored_transactions_in_invalid_format() -> None:
    pass
